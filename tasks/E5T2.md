# E5T2 — Duplicate Vote Handling

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Ensure that duplicate votes from the same user overwrite the previous vote. Use database constraints and transactions to enforce this. Depends on E2T1.
