# E2T1 — Voting Buttons and Vote Recording

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Add inline buttons for each option in the posted poll. When a user taps an option, record the vote in the database. Allow only one vote per user, with the latest vote overwriting the previous. Depends on E1T4.
