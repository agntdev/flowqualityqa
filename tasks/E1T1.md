# E1T1 — Create Poll Entry Point

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Add a 'Create poll' inline button to the /start main menu. When tapped, initiate the poll creation flow in the same chat. Depends on T02.
