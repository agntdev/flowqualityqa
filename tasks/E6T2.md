# E6T2 — Minimum and Maximum Option Validation Test

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Write BotSpec tests for minimum and maximum option validation (1 option rejected, 6th option rejected). Depends on E1T3.
