# E1T4 — Poll Preview and Posting

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Show a preview of the poll with [Post poll], [Edit options], [Toggle anonymous], and [Cancel] buttons. On posting, create the poll message in the same chat with voting buttons and control buttons. Depends on E1T3.
