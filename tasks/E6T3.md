# E6T3 — Voting and Duplicate Vote Handling Test

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Write BotSpec tests for voting and duplicate vote handling. Depends on E2T1.
