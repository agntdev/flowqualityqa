# E4T1 — Poll Data Model and Persistence

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Define and persist the Poll entity with fields: id, chat_id, message_id, creator_user_id, question, is_anonymous, is_closed, created_at, closed_at. Depends on T01.
