# E2T3 — Results Button and Display

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Add a [Results] inline button to the poll message. When tapped, show a compact summary of vote counts and percentages. For named polls, show first N voters (default 10) and 'and X more'. Depends on E2T2.
