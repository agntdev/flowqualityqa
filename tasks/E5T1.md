# E5T1 — Invalid Callback Handling

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Handle invalid or stale callback queries (e.g., removed polls, malformed data) with a message like 'Action no longer available'. Depends on T01.
