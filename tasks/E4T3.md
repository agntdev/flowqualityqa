# E4T3 — Vote Data Model and Persistence

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Define and persist the Vote entity with fields: id, poll_id, user_id, option_id, created_at. Enforce one vote per user per poll. Depends on E4T2.
