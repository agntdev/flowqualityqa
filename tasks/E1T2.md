# E1T2 — Poll Question Input

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Prompt the user to enter a poll question. Validate that the question is non-empty. If empty, reject with a message and re-prompt. Depends on E1T1.
