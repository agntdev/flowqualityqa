...
Implement the inline option builder with [Add option], [Done], [Toggle anonymous], and [Cancel] buttons. Collect 2–5 non-empty options. Validate input and reject empty or out-of-range entries. Depends on E1T2.
