# E3T2 — Export Poll as CSV

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Add an [Export] inline button visible only to the poll creator and admins. When tapped, generate a CSV document with poll data and send it to the requesting user. For anonymous polls, exclude voter identities. Depends on E1T4.
