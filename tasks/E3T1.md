# E3T1 — Close Poll Button and Logic

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Add a [Close poll] inline button visible only to the poll creator and admins. When tapped, set is_closed=true, disable voting buttons, and replace with [Results]. Depends on E1T4.
