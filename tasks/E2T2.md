# E2T2 — Live Results Updates

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

Edit the poll message to reflect live vote totals when votes change. Rate-limit edits to avoid hitting Telegram API limits. Depends on E2T1.
