# E5T3 — Closed Poll Behavior

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 FQABOT

When a poll is closed, disable voting buttons and show a 'Poll is closed' message on any further vote attempts. Depends on E3T1.
